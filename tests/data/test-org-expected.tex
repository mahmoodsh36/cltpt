...
\subsubsection{another due task}\\\#(cltpt/base::make-block :loop `(thing ,(list "some" "thingy" 1 2 3))\\                         :let* `((my-full-title\\                                 ,(if (and 1 3)\\                                   (format nil "<h1> \verb{A - }A </h1>" 4 5)\\                                   ""))))\\  here %my-full-title and %thing\\  \#(cltpt/base::make-block :loop '(thing3 (thing "some2" "thing" 1 2 3))\\                           :let* '((thing4 "hi")\\                                   (thing2 (format nil "hello\textasciitilde{}A" thing3))))\\    thing2 is: %thing2\\    thing3 is: %thing3\\    thing4 is: %thing4\\  \#(cltpt/base::block-end)\\\#(cltpt/base::block-end)\\\subsubsection{header my secondary header}\\test text1\\\subsubsubsection{do something else}\\\subsubsubsection{send the professor a mail}\\hey latex: \(x\)\\some [[mylink1-2:here1][testmore1- 2]] text\\[[attachment:sliding.gif]]\\[[attachment:sliding]]\\comment here\\\textbackslash{}\#+begin\_comment\\this is a comment 2\\\textbackslash{}\#+end\_comment\\some *text*\\text *\\some \textasciitilde{}text\textasciitilde{}\\text \textasciitilde{}\\latex here\\\[ x = \sqrt{x^2} \]\\code here\\\begin{lstlisting}
  import requests
  print('whatever')
  print('whatever2')
\end{lstlisting}
...
\hline\\end     &row   &test  
\hline\end{tabular}\\\( more math \)\\\\\begin{lstlisting}
  import matplotlib
  matplotlib.use('Agg')
