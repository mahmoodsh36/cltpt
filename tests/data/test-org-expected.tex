...
\begin{lstlisting}\href{~/brain/out/jyBtMrE.svg}{}\end{lstlisting}
\\
\begin{dummy}
  this is a test
\end{dummy}
...
\\
escaped macro here: \textbackslash{}\#(format nil "test\textasciitilde{}A" 1)
\\
...
\\
output: %(concatenate 'string "value: [\href{" myvar1 "}{" myvar1 "}]").
\\
\#(cltpt/base::/b)
\\
...
\begin{lstlisting}\href{/home/mahmooz/brain/out/WRB4q2d.svg}{}\end{lstlisting}
\\
test more\end{document}